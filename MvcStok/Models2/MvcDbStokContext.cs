...
public partial class MvcDbStokContext : DbContext
{
    ...
    public virtual DbSet<Tblmusteriler2> Tblmusteriler2s { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-2N06KQ9;Database=MvcStokDb2;integrated security = True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Tblmusteriler2>(entity =>
        {
            entity.HasKey(e => e.Musteriid);

            entity.ToTable("TBLMUSTERILER2");
        ...
        modelBuilder.Entity<Tblsatislar>(entity =>
        {
            ...
            entity.HasOne(d => d.MusteriNavigation).WithMany(p => p.Tblsatislars)
                ...
                .HasConstraintName("FK_TBLSATISLAR_TBLMUSTERILER2");
